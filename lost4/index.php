...
<html lang="en">
  ...
  <div id="stage">
    <div id="stage-caption">
      <h1 class="display-3">WEBSITE LOST AND FOUND</h1>
      <p>A simple, easy to use Lost & Found system.</p>
     <a role="button" href="#" class="btn btn-success" data-toggle="modal" data-target="#signUpWindow">Sign Up/Sign In</a>
              <!-- <a role="button" href="loginandregister.html" class="btn btn-success">Sign Up/Sign In</a> -->
    </div>
  </div>
  ...
  <div class="container">
    <h3 class="display-4" style="text-align:center;">Technologies Used</h3>
  </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" action="includes/signup.php" method="POST" id="valform">
                          ...
                          <div class="form-group">
                           <input type="text" class="form-control" name="rno" placeholder="Roll Number" required>
