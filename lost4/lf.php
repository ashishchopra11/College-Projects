...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h1 class="display-2">Welcome to Lost and Found website, <strong><?php echo("{$_SESSION['username']}");?>!</strong></h1>
      <em><h2 class="display-4">Please select an option below.</h2></em>
    </div>
